...
function SubCategory() {
  const [data, setData] = useState({
    ...
    pname: '',
    pprice:'',
    pimage: null, // Initialize with null for file input
    added: '',
  });
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      formData.append('pimage', data.pimage);
          ...
          <Form onSubmit={handleSubmit}>
            ...
            >
              ...
              {products.map((product) => (
                <option key={product.cid} value={product.cid}>
                  {product.cname}
                </option>
              ))}
            </Form.Control>
            <div className="text-danger">{errors.cid}</div>
            <br />
            ...
            />
            <div className="text-danger">{errors.pid}</div>
            <br />
            <Form.Label>
              <h6>Product Name</h6>
            </Form.Label>
            ...
            />
            <div className="text-danger">{errors.pprice}</div>
            <br />
            <Form.Label>
              <h6>Product Image</h6>
            </Form.Label>
            ...
            />
            <div className="text-danger">{errors.pimage}</div>
          ...
          <Table striped bordered hover>
            <thead>
              <tr>
                ...
                <th className="text-center">Pimage</th>
